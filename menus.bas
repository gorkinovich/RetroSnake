...
1030 PRINT "    {reverse on} {reverse off}  {reverse on}{160}{reverse off}  {reverse on}{red}{169}  {reverse off}{169} {reverse on}{white}{169}   {reverse off}{169} {reverse on}   {127}{reverse off} {reverse on}{green}{169}  {127}"
1040 PRINT "    {reverse on}{white}   {reverse off}{169}  {reverse on}{red} {reverse off}      {reverse on}{white} {reverse off}   {reverse on} {reverse off}  {reverse on}{160}{reverse off} {reverse on}{green} {reverse off}{169}{127}{reverse on} "
1050 PRINT "    {reverse on}{white} {reverse off} {127}{reverse on}{127}{reverse off}  {reverse on}{red}   {reverse off}    {reverse on}{white} {reverse off}   {reverse on}   {reverse off}{169} {reverse on}{green} {reverse off}  {reverse on} "
...
1170 PRINT "    {white}F1:HELP    F5:NEW GAME    Q:EXIT"
1180 PRINT:PRINT
1190 PRINT "      (C) 2022 GORKA SUAREZ GARCIA"
!- =============================================
!- [1200] MAIN MENU LOGIC
!- =============================================
1200 GET KC$
1210 FL%=0 : REM FLAG MENU
1220 IF KC$="{f1}"  THEN 1260 : REM HELP MENU
1230 IF KC$="{f5}"  THEN 3000 : REM NEW GAME (3000)
1240 IF KC$="Q"     THEN 400  : REM EXIT GAME (400)
1245 IF KC$="{209}" THEN 400  : REM EXIT GAME (400)
1250 GOTO 1200
!- =============================================
!- [1260] HELP MENU DRAW
!- =============================================
